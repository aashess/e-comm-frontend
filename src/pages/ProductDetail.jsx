...
function ProductDetail() {
  ...
  const handleBuyNow = () => console.log("Buy now:", product.id);

  // Stagger for product info sections
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Product Image - fade + scale from center */}
          <motion.div
          ...
          {/* Product Details - staggered slide from right */}
          <motion.div
